...
Contributions are welcome! Open an issue or pull request on [GitHub](https://github.com/ddm21/n8n-nodes-swipeone-v1) — bug reports, new operations, and docs improvements are all appreciated.
...
- [SwipeOne API Docs](https://docs.swipeone.com/en/collections/11679463-api)
